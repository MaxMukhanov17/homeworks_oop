...
some_reviewer.courses_in_attached += ['Python']

some_lecturer = Lecturer('Some', 'Buddy')
some_lecturer_other = Lecturer('David', 'Beckham')
some_lecturer.courses_in_attached += ['Python']
some_lecturer_other.courses_in_attached += ['Python']
...
some_student_1.rate_lc(some_lecturer, 'Python', 10)
some_student_1.rate_lc(some_lecturer, 'Python', 10)
some_student_1.rate_lc(some_lecturer, 'Python', 10)

some_student_1.rate_lc(some_lecturer_other, 'Python', 10)
some_student_1.rate_lc(some_lecturer_other, 'Python', 9)
some_student_1.rate_lc(some_lecturer_other, 'Python', 10)
...
print(some_lecturer > some_lecturer_other)